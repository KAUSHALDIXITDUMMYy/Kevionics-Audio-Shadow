      ...
      <div className="max-w-3xl mx-auto space-y-4">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>{PRODUCT_DISPLAY_NAME} – Last updated: March 2025</CardDescription>
          </CardHeader>
          <CardContent className="prose prose-sm dark:prose-invert max-w-none space-y-4">
            ...
            <section>
              ...
              <p>By accessing or using {PRODUCT_DISPLAY_NAME} (&quot;Service&quot;), you agree to be bound by these Terms and our content and conduct policies.</p>
            </section>
